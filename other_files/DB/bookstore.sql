...
-- -----------------------------------------------------
-- Table `bookstore`.`UserGroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`UserGroup` (
  `uesrGroup_id` INT(10) NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`uesrGroup_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bookstore`.`User` (
  ...
  CONSTRAINT `User_fk1`
    ...
    REFERENCES `bookstore`.`UserGroup` (`uesrGroup_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `bookstore`.`Distributor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`Distributor` (
...
CREATE TABLE IF NOT EXISTS `bookstore`.`Book` (
  ...
  CONSTRAINT `Book_fk2`
    FOREIGN KEY (`user_id`)
    REFERENCES `bookstore`.`User` (`usr_id`),
  CONSTRAINT `Book_fk3`
    FOREIGN KEY (`genre_id`)
    REFERENCES `bookstore`.`Genre` (`genre_id`),
  CONSTRAINT `Book_fk4`
    FOREIGN KEY (`distr_id`)
    REFERENCES `bookstore`.`Distributor` (`distr_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`Comment` (
...
-- -----------------------------------------------------
-- Table `bookstore`.`PurchasedBook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`PurchasedBook` (
  `pur_id` INT(10) NOT NULL AUTO_INCREMENT,
  `usr_id` INT(10) NULL DEFAULT NULL,
  `book_id` INT(10) NULL DEFAULT NULL,
  `date` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`pur_id`),
  INDEX `PurchasedBook_fk1` (`usr_id` ASC),
